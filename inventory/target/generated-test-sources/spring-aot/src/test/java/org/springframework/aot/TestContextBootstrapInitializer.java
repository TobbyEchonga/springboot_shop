...
public class TestContextBootstrapInitializer {
  public static Map<String, Supplier<SmartContextLoader>> getContextLoaders() {
    ...
    entries.put("com.example.inventory.InventoryApplicationTests", () -> new AotSpringBootConfigContextLoader(InventoryApplicationTestsContextInitializer.class, WebApplicationType.SERVLET, SpringBootTest.WebEnvironment.MOCK));
    return entries;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializers(
    ...
    entries.put("com.example.inventory.InventoryApplicationTests", InventoryApplicationTestsContextInitializer.class);
    return entries;
  }
}
