...
public final class InventoryApplicationTestsContextInitializer {
  ...
  public static void registerJdbcTemplateConfiguration_jdbcTemplate(
    ...
    BeanDefinitionRegistrar.of("jdbcTemplate", JdbcTemplate.class).withFactoryMethod(JdbcTemplateConfiguration.class, "jdbcTemplate", DataSource.class, JdbcProperties.class)
        .instanceSupplier((instanceContext) -> instanceContext.create(beanFactory, (attributes) -> beanFactory.getBean(JdbcTemplateConfiguration.class).jdbcTemplate(attributes.get(0), attributes.get(1)))).customize((bd) -> bd.setPrimary(true)).register(beanFactory);
  }
  ...
  public static void registerNamedParameterJdbcTemplateConfiguration_namedParameterJdbcTemplate(
    ...
    BeanDefinitionRegistrar.of("namedParameterJdbcTemplate", NamedParameterJdbcTemplate.class).withFactoryMethod(NamedParameterJdbcTemplateConfiguration.class, "namedParameterJdbcTemplate", JdbcTemplate.class)
        .instanceSupplier((instanceContext) -> instanceContext.create(beanFactory, (attributes) -> beanFactory.getBean(NamedParameterJdbcTemplateConfiguration.class).namedParameterJdbcTemplate(attributes.get(0)))).customize((bd) -> bd.setPrimary(true)).register(beanFactory);
  }
