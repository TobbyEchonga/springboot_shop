...
public final class InventoryApplicationTestsContextInitializer {
  ...
  public static void registerThymeleafAutoConfiguration_ThymeleafDefaultConfiguration(
      DefaultListableBeanFactory beanFactory) {
    BeanDefinitionRegistrar.of("org.springframework.boot.autoconfigure.thymeleaf.ThymeleafAutoConfiguration$ThymeleafDefaultConfiguration", ThymeleafAutoConfiguration.ThymeleafDefaultConfiguration.class)
        .instanceSupplier(ThymeleafAutoConfiguration.ThymeleafDefaultConfiguration::new).register(beanFactory);
  }

  public static void registerThymeleafDefaultConfiguration_templateEngine(
      DefaultListableBeanFactory beanFactory) {
    BeanDefinitionRegistrar.of("templateEngine", SpringTemplateEngine.class).withFactoryMethod(ThymeleafAutoConfiguration.ThymeleafDefaultConfiguration.class, "templateEngine", ThymeleafProperties.class, ObjectProvider.class, ObjectProvider.class)
        .instanceSupplier((instanceContext) -> instanceContext.create(beanFactory, (attributes) -> beanFactory.getBean(ThymeleafAutoConfiguration.ThymeleafDefaultConfiguration.class).templateEngine(attributes.get(0), attributes.get(1), attributes.get(2)))).register(beanFactory);
  }
